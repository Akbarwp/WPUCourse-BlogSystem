                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route("post.store") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset class="fieldset">
                            ...
                            <input type="file" name="cover_image" class="file-input w-full" placeholder="Type here" value="{{ old("cover_image") }}" />
                            @error("cover_image")
                        ...
                        <fieldset class="fieldset">
                            ...
                            <textarea rows="10" name="body" class="textarea @error("body") textarea-error bg-red-50 @enderror w-full" placeholder="Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero, optio?" required>{{ old("body") }}</textarea>
                            @error("body")
                                <p class="label text-error">{{ $message }}</p>
                            @enderror
                        </fieldset>
